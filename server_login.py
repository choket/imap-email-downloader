...
def server_login(user_or_email_or_combo: str,
                 ...
                 timeout: Optional[Union[float, int]] = None) -> Union[imaplib.IMAP4, imaplib.IMAP4_SSL]:
...
def main():
    ...
    try:
        server_login(user_or_email_or_combo=username,
                     password=password,
                     host=host,
                     port=port,
                     use_ssl=ssl,
